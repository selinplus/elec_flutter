...
class PresComponent extends StatelessWidget {
  Doctor doctor;
  Prescription prescription;
  final refresh;
  PresComponent({this.doctor,this.prescription,this.refresh});
  @override
                  ...
                  Container(
                    ...
                    child:RaisedButton(
                        ...
                        textColor: Theme
                            .of(context)
                            .accentColor,
                        child: Text("开具处方", style: TextStyle(fontSize: 12)),
                        color: Colors.white,
                        shape: Border.all(
                            color: Theme
                                .of(context)
...
//                          preMedicine.times=listPres[i]["times"];
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                                      //指定跳转的页面
                                      return PrescriptionPage(doctor:doctor,prescription: prescription,patient: patient,preMedicine: preMedicines,);
                                    },)).then((_){
                                      refresh();
                                    });
                                  }
