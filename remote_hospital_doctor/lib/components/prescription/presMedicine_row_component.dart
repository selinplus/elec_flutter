...
import 'package:remote_hospital_doctor/components/prescription/medicine_num_row_component.dart';
class PresMedicineRowComponent extends StatelessWidget {
  ...
  PresMedicineRowComponent({this.index,this.medicine,this.callback,this.increment,this.reduce,this.canOper,this.changeMdRoute,this.changeMdTimes,this.changeYyjl,this.mdrouteList,this.mdtimesList});
   _getMdRouteList(){
