...
import 'package:remote_hospital_doctor/components/prescription/pres_component.dart';
import 'package:remote_hospital_doctor/services/pref_util.dart';
class PresListComponent extends StatefulWidget {
//  Doctor doctor;
//  PresListComponent({this.doctor});
  @override
  _PresListComponentState createState() => _PresListComponentState();
}

class _PresListComponentState extends State<PresListComponent> {
 ...
 void _getPres(){
   ...
   getPrefInt("doctorid").then((result){
     ...
     doctor.ID=doctorid;
     params["id"]=doctor.ID;
       DioUtil().get(true,"/api/v1/prescription/cfyishi",queryParameters: params,errorCallback: (statuscode){
      ...
      child:Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (BuildContext context,int index){
            return PresComponent( doctor:doctor,prescription:prescriptions[index],refresh:_getPres,);
          },
