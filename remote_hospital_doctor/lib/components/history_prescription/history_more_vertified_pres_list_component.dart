...
class HistoryMoreVertifiedPresListComponent extends StatefulWidget {
//  Doctor doctor;
//  HistoryNoververtifiedPresListComponent({this.doctor});
  @override
  _HistoryMoreVertifiedPresListComponentState createState() => _HistoryMoreVertifiedPresListComponentState();
}

class _HistoryMoreVertifiedPresListComponentState extends State<HistoryMoreVertifiedPresListComponent> {
  ...
  void _getPres(){
    ...
    getPrefInt("doctorid").then((result){
      ...
      doctor.ID=doctorid;
      params["id"]=doctor.ID;
      DioUtil().get(true,"/api/v1/prescription/cfuriysmt",queryParameters: params,errorCallback: (statuscode){
