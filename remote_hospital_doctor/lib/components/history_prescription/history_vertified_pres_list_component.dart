...
class HistoryVertifiedPresListComponent extends StatefulWidget {
//  Doctor doctor;
//  HistoryNoververtifiedPresListComponent({this.doctor});
  @override
  _HistoryVertifiedPresListComponentState createState() => _HistoryVertifiedPresListComponentState();
}

class _HistoryVertifiedPresListComponentState extends State<HistoryVertifiedPresListComponent> {
  ...
  void _getPres(){
    ...
    getPrefInt("doctorid").then((result){
      ...
      doctor.ID=doctorid;
      params["id"]=doctor.ID;
      DioUtil().get(true,"/api/v1/prescription/cfuriys",queryParameters: params,errorCallback: (statuscode){
