...
import 'package:remote_hospital/components/history_prescription/history_pres_list_component.dart';
    ...
    return Scaffold(
         appBar: AppBar(
                  ...
                  child: TabBar(
                      ...
                      tabs: <Widget>[
                        Container(
                          ...
                          child:Text("未分配",style: TextStyle(fontSize: 12),),
                        ),
                        Container(
                          height: 30,
                          alignment: Alignment.center,
                          child:Text("未签字",style: TextStyle(fontSize: 12),),
                        ),
                        Container(
                          height: 30,
                          alignment: Alignment.center,
          ...
          body:TabBarView(
              controller: _tabController,
              children: <Widget>[
                HistoryNosendPresListComponent(),
                HistorySendPresListComponent(),
                HistoryTodayPresListComponent(),
                HistoryPresListComponent(),
              ],
