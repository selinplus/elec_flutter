...
class MdPresListComponent extends StatefulWidget {
//  Mendian mendian;
//  MdPresListComponent({this.mendian});
  @override
  _MdPresListComponentState createState() => _MdPresListComponentState();
}

class _MdPresListComponentState extends State<MdPresListComponent> {
...
// })
      getPrefInt("mdid").then((result){
       ...
       DioUtil().get(true,"/api/v1/prescription/cfyaoshi",queryParameters: params,errorCallback: (statuscode){
