...
import 'package:remote_hospital/screens/md_prescription_page.dart';
import 'package:remote_hospital/screens/patient_details_page.dart';
class MdPresComponent extends StatelessWidget {
  Mendian mendian;
  Prescription prescription;
  final refresh;
  MdPresComponent({this.mendian,this.prescription,this.refresh});
...
//                          if(mendian.yaosshuri==""||mendian.yaosshuri==null){
//                            Fluttertoast.showToast(
//                                msg: '门店尚没有维护审核药师签字，不能发放处方',
//                                toastLength: Toast.LENGTH_SHORT,
//                                gravity: ToastGravity.CENTER,
//                                timeInSecForIos: 1,
//                                backgroundColor:Colors.red,
                              ...
                              if (_pres["data"] is List) {
                                ...
                                if (_pres["data"][0] is Map) {
                                  ...
                                  if(_pres["data"][0] is Map){
                                    ...
                                    Navigator.push(context, MaterialPageRoute(builder: (context) {
                                      //指定跳转的页面
                                      return MdPrescriptionPage(mendian:mendian,prescription: prescription,patient: patient,doctor:doctor, preMedicine: preMedicines,);
                                    },)).then((_){
                                      refresh();
                                    });
                                  }
