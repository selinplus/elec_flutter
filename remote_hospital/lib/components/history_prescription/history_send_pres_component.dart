...
import 'package:remote_hospital/screens/history_nosign_prescription_page.dart';
import 'package:remote_hospital/screens/patient_details_page.dart';
class HistorySendPresComponent extends StatelessWidget {
  Mendian mendian;
  Prescription prescription;
  final refresh;
  HistorySendPresComponent({this.mendian,this.prescription,this.refresh});
  @override
...
//              color: Colors.red,
                      alignment: Alignment.centerLeft,
                      padding: EdgeInsets.only(left: 10.0),
                      child: Text("医师：${prescription.yishi_name}",style: TextStyle(fontSize: 12)),
                    )
...
//              color: Colors.red,
                  ...
                  child: Text("${prescription.updated_at}",style: TextStyle(fontSize: 12)),
                )
              ],
            ),
            Divider(height: 1.0,),
...
//                    preMedicine.times=listPres[i]["times"];
                                  ...
                                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                                    ...
                                    return HistoryNosignPrescriptionPage(patient:patient, prescription: prescription, preMedicines: preMedicines,doctor:doctor,);
                                  },)).then((_){
                                    refresh();
                                  });
                                }
