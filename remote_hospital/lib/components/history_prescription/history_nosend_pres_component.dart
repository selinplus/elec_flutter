...
class HistoryNosendPresComponent extends StatelessWidget {
  Mendian mendian;
  Prescription prescription;
  final refresh;
  HistoryNosendPresComponent({this.mendian,this.prescription,this.refresh});
  @override
...
//              color: Colors.red,
                          alignment: Alignment.centerLeft,
                          padding: EdgeInsets.only(left: 10.0),
                          child: Text("${prescription.cfkjsj}",style: TextStyle(fontSize: 12)),
                      )
                  ),
                ],
              ),
