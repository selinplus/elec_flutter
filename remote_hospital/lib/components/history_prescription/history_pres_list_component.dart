...
class HistoryPresListComponent extends StatefulWidget {
//  Mendian mendian;
//  MdPresListComponent({this.mendian});
  @override
  _HistoryPresListComponentState createState() => _HistoryPresListComponentState();
}

class _HistoryPresListComponentState extends State<HistoryPresListComponent> {
...
//     params["id"]=3;
    getPrefString("yaosshuri").then((val){
      ...
      DioUtil().get(true,"/api/v1/prescription/cfurimt",queryParameters: params,errorCallback: (statuscode){
