...
import 'package:remote_hospital/components/history_prescription/history_nosend_pres_component.dart';
import 'package:remote_hospital/services/pref_util.dart';
class HistoryNosendPresListComponent extends StatefulWidget {
//  Mendian mendian;
//  MdPresListComponent({this.mendian});
  @override
  _HistoryNosendPresListComponentState createState() => _HistoryNosendPresListComponentState();
}

class _HistoryNosendPresListComponentState extends State<HistoryNosendPresListComponent> {
 ...
 void _getPres() {
   ...
   getPrefInt("mdid").then((result){
       ...
       DioUtil().get(true,"/api/v1/prescription/cfmd",queryParameters: params,errorCallback: (statuscode){
      ...
      child:Container(
        ...
        child: ListView.separated(
          ...
          itemBuilder: (BuildContext context,int index){
            return HistoryNosendPresComponent( mendian:mendian,prescription:prescriptions[index],refresh:_getPres,);
          },
