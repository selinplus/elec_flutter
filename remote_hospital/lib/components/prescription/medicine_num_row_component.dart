                  ...
                  child: Row(
                    children: <Widget>[
                      ...
                      Container(
                        ...
                        alignment: Alignment.center,
                        child: !canOper?Text("数量：",style: TextStyle(fontSize: 12,color: Colors.grey),):null,
                      ),
                      Container(
//                        width: 30,
                        padding: EdgeInsets.symmetric(horizontal: 0.0),
                        alignment: Alignment.center,
                        child: Text(unit==null?"${num.toString()}":"${num.toString()}$unit",style: TextStyle(fontSize: canOper?12.0:12.0,color: canOper?Colors.black:Colors.grey),),
                      ),
                      Container(
                        //color:Colors.red,
                        padding: EdgeInsets.symmetric(horizontal: 0.0),
